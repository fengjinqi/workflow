<template>
    <div class="fiter">
        <div class="main">
            <div class="fiter-item flex">
                <div class="fiter-item-name">品牌</div>
                ...
                <div class="fiter-item-list flex">
                    <el-checkbox-group v-model="checkedFiters1" @change="handleCheckedFitersChange1">
                        <el-checkbox v-for="item in list.list" :label="item.name" :key="item.id">{{item.name}}</el-checkbox>
                    </el-checkbox-group>
                </div>
...
.reset{
    ...
    .fiter{
        ...
        .fiter-item{
            ...
            background:#fff;
            .fiter-item-name,.fiter-item-all{
                margin-right: 20px;
                text-align: right;
                width: 56px;
            }
